<template>
  <div class="purchas">
    <el-dialog
      ...
      width="55%"
    >
      <div class="foll_list" v-if="works.product">  
        <div class="left">
          <img v-if="works.product" :src="ip + works.product.resources[0].address" alt="" />
        </div>
        <div class="right">
          <div class="list">
            <p class="key">资产名称:</p>
          ...
          <div class="list">
            <p class="key">数量:</p>
            <p class="value">
              <span style="color: #3772ff">{{ works.product.left }}</span
              >/{{ works.product.count }}
            </p>
          </div>
          <div class="list">
            <p class="key">持有者:</p>
            <p class="value">
              <img :src="ip + works.owner.avatar" alt="" />
              {{ works.owner.nickname }}
            </p>
          </div>
