...
const jsonencode = (jsondata:any) => encodeURIComponent(encode(encodeURIComponent(JSON.stringify(jsondata))));
const jsondecode = (jsonstr:any) => JSON.parse(decodeURIComponent(decode(decodeURIComponent(jsonstr))));
